...
export function fetchTNotesGeneral(periodeEval: number): Promise<any> {
  return new Promise(async (resolve, reject) => {
    try {
      const sql = `SELECT T_Notes.RefElève AS idEleve, T_Notes.RefTypeClasse, T_Notes.RefClasse, T_Notes.CF1, T_Notes.OG1, T_Notes.EO1, T_Notes.FR1, T_Notes.PHILO1, T_Notes.HG1, T_Notes.AN1, T_Notes.LV21, T_Notes.MATH1, T_Notes.SP1, T_Notes.SVT1, T_Notes.EPS1, T_Notes.APMUS1, T_Notes.ECM1, T_Notes.COND1, T_Notes.MOYG1, T_Notes.MOYG2, T_Notes.MOYG3, T_Notes.MOYG4, T_Notes.MCA1, T_Notes.MCB1, T_Notes.Info1, T_Notes.TM1, T_Notes.MCC1, T_Notes.MCD1, Elèves.LV2, Elèves.Arts, Classes.LV2 AS classeLV2, Classes.Arts AS classeArts, T_Notes.CoefFR1, T_Notes.CoefPHILO1, T_Notes.CoefHG1, T_Notes.CoefAN1, T_Notes.CoefLV21, T_Notes.CoefMATH1, T_Notes.CoefSP1, T_Notes.CoefSVT1, T_Notes.CoefEPS1, T_Notes.CoefAPMUS1, T_Notes.CoefECM1, T_Notes.CoefCOND1, Elèves.TélTuteur AS telTuteur, Elèves.NomElève AS nomEleve, Elèves.PrénomElève AS prenomEleve, Classes.ClasseCourt AS libelleClasseCourt, ordre_enseig.ref_ordre_enseig AS idOrdreEnseignement, Classes.ClasseLong AS libelleClasseLong, Elèves.MatriculeNational AS matriculeEleve, TypesClasses.Série AS serie, TypesClasses.RefTypeClasse AS idTypeClasse, Niveaux.RefNiveau AS idNiveau, Filières.OrdreEnseignement AS ordreEnseignement, Niveaux.NiveauCourt AS libelleNiveauCourt, Classes.RefClasse AS idClasse, IIf(IsNull([TypesClasses].[Série]),[Niveaux].[NiveauCourt],[Niveaux].[NiveauCourt] & ' ' & [TypesClasses].[Série]) AS libelleNiveauParSerie, Elèves.Décision AS decision, Elèves.Sexe AS sexe
 ...
 * @returns 
 */
 function fetchTNotesTechnique(periodeEval: number): Promise<any> {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      Classes.ClasseCourt AS libelleClasseCourt, ordre_enseig.ref_ordre_enseig AS idOrdreEnseignement,
       Elèves.MatriculeNational AS matriculeEleve, Niveaux.RefNiveau AS idNiveau,
        Niveaux.NiveauCourt AS libelleNiveauCourt, ordre_enseig.lib_ordre_enseig AS libelleOrdreEnseignement,
         ...
         IIf(IsNull([TypesClasses].[Série]),[Niveaux].[NiveauCourt],[Niveaux].[NiveauCourt] & ' ' & [TypesClasses].[Série]) AS libelleNiveauParSerie, Elèves.Sexe AS sexe, Classes.OrdreClasse, Elèves.NomElève, Elèves.PrénomElève, TypesClasses.RefTypeClasse AS idTypeClasse, TypesClasses.Série AS serie
    ...
    try {
      const sql = `SELECT Notes.RefElève AS idEleve, Notes.RangCF1, Notes.RangOG1, Notes.RangEO1, Notes.RangFR1, Notes.RangPHILO1, Notes.RangHG1,
       Notes.RangAN1, Notes.RangLV21, Notes.RangMATH1, Notes.RangSP1, Notes.RangSVT1, Notes.RangEPS1, Notes.RangAPMUS1,
        Notes.RangECM1, Notes.RangMCA1, Notes.RangMCB1, Notes.RangInfo1, Notes.RangMCC1, Notes.RangMCD1, Notes.RangG1, Notes.RangG2, Notes.RangG3, Notes.RangG4
      FROM Notes;            
      `.replace(/1/g, periodeEval.toString());
      const result = await fetchFromMsAccess<any[]>(sql, appCnx);
      resolve(result);
