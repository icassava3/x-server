...
// liste nominative troisieme trimestre

// const ObservationTrimestrielle = () => {
//   return new Promise(async (resolve, reject) => {
//     try { 
...
//       resolve(sqlResult);
//     } catch (err: any) {
//       console.log(`err => ObservationTrimestrielle`);
//       return reject(err);
//     }
//   });
// };
...
const rapport = (data: any): Promise<any> => {
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      // console.log("🚀 ~ file: functions.ts:2150 ~ returnnewPromise ~ chp1_B_1_c_1:", result.chp1_B_1_c_1)
      resolve(result);
    } catch (err: any) {
      return reject(err);
    }
