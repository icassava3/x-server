...
export interface IChp2_4 {
  GarçonIvoirienNonRedoub: number,
  FilleIvoirienNonRedoub: number,
  T1: number,
  GarçonIvoirienDoublant: number,
  FilleIvoirienDoublant: number,
  T2: number,
  TotalGarçonIvoirienEtNon: number,
  TotalFilleIvoirienEtNon: number,
  T3: number,
  GarçonRedoudIvoirien: number,
  FilleRedoudIvoirien: number,
  T4: number,
  GarçonRedoudNonIvoirien: number,
  FilleRedoudNonIvoirien: number,
  T5: number,
  TotalRedoubGarçonIvoirienEtNon: number,
  TotalRedoubFilleIvoirienEtNon: number,
  T6: number,
  TotaGeneralGarçon: number,
  TotaGeneralFille: number,
  Total: number,
}
...
export interface IChp_C_2_2 {
  Dates: string,
  NomCompletElve: string,
  Matricule: string,
  Classe: string,
  Genre: string,
  Objet: string,
...
export interface IChp7_6_1 {
  ...
  AdmisFille: string;
  TotalPresent: number;
  TauxAdmisFille: number;
  TauxAdmisGarçon: number;
  TauxAdmis: number;
