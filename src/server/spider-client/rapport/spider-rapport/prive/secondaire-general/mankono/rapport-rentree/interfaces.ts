...
export interface IChp_A_1 {
  CycleX: string;
  NiveauSerie: string;
  classePedagogique: string;
  classePhysique: string;
  G1: number;
  F1: number;
  T1: number;
  G3: number;
...
export interface IChp_B_1 {
  ...
  TotalInscrit: number;
  PresentFille: number;
  PresentGarçon: number;
  TotalPresent: number;
  FilleAdmis: number;
  GarçonAdmis: number;
  TauxGarçonAdmis: number;
  TotalTaux: number;
}
...
export interface IChp4_A_1 {
  ...
  NumCnps:string, 
  NumAuth:string, 
  VacataireFonct:string, 
  PrivePermanent:string, 
  VacatairePrives:string, 
}

export interface IChp4_A_4 {
  FR1: number;
  FR2: number;
  HG1: number;
  HG2: number;
