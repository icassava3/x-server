...
const chp1_B_3_liste_major_classe_niveau = () => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      Classes.OrdreClasse, 
      Classes.ClasseCourt, 
      T_Notes.MOYG1 AS MoyG3, Niveaux.NiveauCourt, 
...
ORDER BY TypesClasses.RefTypeClasse, Classes.OrdreClasse, Classes.ClasseCourt, T_Notes.MOYG1 DESC , Notes.RangG1, Niveaux.RefNiveau, Classes.ClasseCourt, [NomElève] & " " & [PrénomElève];
      `;
...
const chp4_A_etat_du_personnel_administratif_et_encadrement = () => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      Diplomes.NomDiplome, Fonction.Fonction, 
...
const chp5_C_situation_des_eleves_affectes_de_l_etat = () => {
  return new Promise(async (resolve, reject) => {
    try {
      let sql = `
          SELECT IIf([Elèves].[Bourse]="BE" Or [Elèves].[Bourse]="1/2B","Boursiers","Non Boursiers") AS label, Count(IIf([Elèves].[Sexe]=1 And [Classes].[RefTypeClasse] In (1),1,Null)) AS _6e_G, 
          Count(IIf([Elèves].[Sexe]=2 And [Classes].[RefTypeClasse] In (1),1,Null)) AS _6e_F, Count(IIf([Elèves].[Sexe]=1 And [Classes].[RefTypeClasse] In (2),1,Null)) AS _5e_G, 
          Count(IIf([Elèves].[Sexe]=2 And [Classes].[RefTypeClasse] In (2),1,Null)) AS _5e_F, Count(IIf([Elèves].[Sexe]=1 And [Classes].[RefTypeClasse] In (3),1,Null)) AS _4e_G, 
          Count(IIf([Elèves].[Sexe]=2 And [Classes].[RefTypeClasse] In (3),1,Null)) AS _4e_F, Count(IIf([Elèves].[Sexe]=1 And [Classes].[RefTypeClasse] In (4),1,Null)) AS _3e_G, 
          Count(IIf([Elèves].[Sexe]=2 And [Classes].[RefTypeClasse] In (4),1,Null)) AS _3e_F, Count(IIf([Elèves].[Sexe]=1 And [Classes].[RefTypeClasse] In (1,2,3,4),1,Null)) AS ST1_G, 
          Count(IIf([Elèves].[Sexe]=2 And [Classes].[RefTypeClasse] In (1,2,3,4),1,Null)) AS ST1_F, Count(IIf([Elèves].[Sexe]=1 And [Classes].[RefTypeClasse] In (5,6),1,Null)) AS _2nd_G, 
...
const rapport = (data: any): Promise<any> => {
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const result = {
        ...dataParams,
        name_report: "prive_secondairegeneral_sanpedro_1trimestre",
