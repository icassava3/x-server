  ...
  return new Promise(async (resolve, reject) => {
    try {
      let sql = `
          ...
          ORDER BY 1, 2,3,4;
          UNION ALL 
          SELECT Max(Niveaux.RefNiveau) AS RefNiveau, "Total" AS NiveauCourt, "Total Etab" AS ClasseCourt, "#E3E3E3" AS bg, Count(IIf([SEXE]=2,1,Null)) AS F1, Count(IIf([SEXE]=1,1,Null)) AS G1, [F1]+[G1] AS T1, Count(Elèves.RefElève) AS EffectTotal, Count(IIf([MOYG2] Is Not Null And [SEXE]=2,1,Null)) AS F2, Count(IIf([MOYG2] Is Not Null And [SEXE]=1,1,Null)) AS G2, [F2]+[G2] AS T2, Count(IIf([MOYG2] Is Null,Null,1)) AS EffectClasse, Count(IIf([MOYG2] Is Null,1,Null)) AS EffectNonClasse, Count(IIf([MOYG2]>=10,1,Null)) AS Tranche1, IIf([EffectClasse]=0,0,Round([Tranche1]/[EffectClasse]*100,2)) AS Taux1, Count(IIf([MOYG2] Between 8.5 And 9.99,1,Null)) AS Tranche2, IIf([EffectClasse]=0,0,Round([Tranche2]/[EffectClasse]*100,2)) AS Taux2, Count(IIf([MOYG2] Between 0 And 8.49,1,Null)) AS Tranche3, IIf([EffectClasse]=0,0,Round([Tranche3]/[EffectClasse]*100,2)) AS Taux3, IIf([EffectClasse]<1,0,Round(Sum([MOYG2])/[EffectClasse],2)) AS MoyClasse
          FROM ((Niveaux INNER JOIN (TypesClasses INNER JOIN Classes ON TypesClasses.RefTypeClasse = Classes.RefTypeClasse) ON Niveaux.RefNiveau = TypesClasses.Niveau) INNER JOIN T_Notes ON Classes.RefClasse = T_Notes.RefClasse) INNER JOIN Elèves ON T_Notes.RefElève = Elèves.RefElève
          HAVING (((TypesClasses.filière)=1) AND ((Elèves.inscrit)=Yes) AND ((Elèves.StatutElève)${StatutEleve}))
          ORDER BY 1, 2, 3, 4;
              `;
...
const chp2_B_situation_des_effectifs_apres_le_conseil_des_classes = () => {
  return new Promise(async (resolve, reject) => {
    try {
      let sql = `
              SELECT Niveaux.RefNiveau, IIf(IsNull([Cycle]),Null,[cycle]) AS CycleX, 1 AS orderby, [NiveauCourt] & " " & [Série] AS NiveauSerie, "#FFFF" AS bg, Count(IIf([SEXE]=2,1,Null)) AS F1, Count(IIf([SEXE]=1,1,Null)) AS G1, [F1]+[G1] AS T1, Count(Elèves.RefElève) AS EffectTotal, Count(IIf([MOYG2] Is Not Null And [SEXE]=2,1,Null)) AS F2, Count(IIf([MOYG2] Is Not Null And [SEXE]=1,1,Null)) AS G2, [F2]+[G2] AS T2, Count(IIf([MOYG2] Is Null,Null,1)) AS EffectClasse, Count(IIf([MOYG2] Is Null,1,Null)) AS EffectNonClasse, Count(IIf([SEXE]=2 And [Redoub]=True,1,Null)) AS F3, Count(IIf([SEXE]=1 And [Redoub]=True,1,Null)) AS G3, [F3]+[G3] AS T3, Count(IIf([SEXE]=2 And [MOYG2]>=10,1,Null)) AS F4, Count(IIf([SEXE]=1 And [MOYG2]>=10,1,Null)) AS G4, [F4]+[G4] AS T4, Count(IIf([MOYG2]>=10,1,Null)) AS Tranche1, IIf([EffectClasse]=0,0,Round([Tranche1]/[EffectClasse]*100,2)) AS Taux1, Count(IIf([MOYG2] Between 8.5 And 9.99,1,Null)) AS Tranche2, IIf([EffectClasse]=0,0,Round([Tranche2]/[EffectClasse]*100,2)) AS Taux2, Count(IIf([MOYG2] Between 0 And 8.49,1,Null)) AS Tranche3, IIf([EffectClasse]=0,0,Round([Tranche3]/[EffectClasse]*100,2)) AS Taux3, IIf([EffectClasse]<1,0,Round(Sum([MOYG2])/[EffectClasse],2)) AS MoyClasse
              FROM ((Niveaux INNER JOIN (TypesClasses INNER JOIN Classes ON TypesClasses.RefTypeClasse = Classes.RefTypeClasse) ON Niveaux.RefNiveau = TypesClasses.Niveau) INNER JOIN T_Notes ON Classes.RefClasse = T_Notes.RefClasse) INNER JOIN Elèves ON T_Notes.RefElève = Elèves.RefElève
              ...
              UNION ALL(
              SELECT First(Niveaux.RefNiveau) AS RefNiveau, IIf(IsNull([Cycle]),Null,[cycle]) AS CycleX, 2 AS orderby, "Total " & First([CycleX]) AS NiveauSerie, "#EBEBEB" AS bg, Count(IIf([SEXE]=2,1,Null)) AS F1, Count(IIf([SEXE]=1,1,Null)) AS G1, [F1]+[G1] AS T1, Count(Elèves.RefElève) AS EffectTotal, Count(IIf([MOYG2] Is Null Or [SEXE]=2,Null,1)) AS F2, Count(IIf([MOYG2] Is Null Or [SEXE]=1,Null,1)) AS G2, [F2]+[G2] AS T2, Count(IIf([MOYG2] Is Null,Null,1)) AS EffectClasse, Count(IIf([MOYG2] Is Null,1,Null)) AS EffectNonClasse, Count(IIf([SEXE]=2 And [Redoub]=True,1,Null)) AS F3, Count(IIf([SEXE]=1 And [Redoub]=True,1,Null)) AS G3, [F3]+[G3] AS T3, Count(IIf([SEXE]=2 And [MOYG2]>=10,1,Null)) AS F4, Count(IIf([SEXE]=1 And [MOYG2]>=10,1,Null)) AS G4, [F4]+[G4] AS T4, Count(IIf([MOYG2]>=10,1,Null)) AS Tranche1, IIf([EffectClasse]=0,0,Round([Tranche1]/[EffectClasse]*100,2)) AS Taux1, Count(IIf([MOYG2] Between 8.5 And 9.99,1,Null)) AS Tranche2, IIf([EffectClasse]=0,0,Round([Tranche2]/[EffectClasse]*100,2)) AS Taux2, Count(IIf([MOYG2] Between 0 And 8.49,1,Null)) AS Tranche3, IIf([EffectClasse]=0,0,Round([Tranche3]/[EffectClasse]*100,2)) AS Taux3, IIf([EffectClasse]<1,0,Round(Sum([MOYG2])/[EffectClasse],2)) AS MoyClasse
              FROM ((Niveaux INNER JOIN (TypesClasses INNER JOIN Classes ON TypesClasses.RefTypeClasse = Classes.RefTypeClasse) ON Niveaux.RefNiveau = TypesClasses.Niveau) INNER JOIN T_Notes ON Classes.RefClasse = T_Notes.RefClasse) INNER JOIN Elèves ON T_Notes.RefElève = Elèves.RefElève
              ...
              UNION ALL (
              SELECT Last([Niveaux].[RefNiveau]) AS RefNiveau, "2nd Cycle" AS CycleX, 1 AS orderby, "Tle A" AS NiveauSerie, "#FFFF" AS bg, Count(IIf([SEXE]=2,1,Null)) AS F1, Count(IIf([SEXE]=1,1,Null)) AS G1, [F1]+[G1] AS T1, 0 AS EffectTotal, Count(IIf([MOYG2] Is Not Null And [SEXE]=2,1,Null)) AS F2, Count(IIf([MOYG2] Is Not Null And [SEXE]=1,1,Null)) AS G2, [F2]+[G2] AS T2, Count(IIf([MOYG2] Is Null,Null,1)) AS EffectClasse, Count(IIf([MOYG2] Is Null,1,Null)) AS EffectNonClasse, Count(IIf([SEXE]=2 And [Redoub]=True,1,Null)) AS F3, Count(IIf([SEXE]=1 And [Redoub]=True,1,Null)) AS G3, [F3]+[G3] AS T3, Count(IIf([SEXE]=2 And [MOYG2]>=10,1,Null)) AS F4, Count(IIf([SEXE]=1 And [MOYG2]>=10,1,Null)) AS G4, [F4]+[G4] AS T4, Count(IIf([MOYG2]>=10,1,Null)) AS Tranche1, IIf([EffectClasse]=0,0,Round([Tranche1]/[EffectClasse]*100,2)) AS Taux1, Count(IIf([MOYG2] Between 8.5 And 9.99,1,Null)) AS Tranche2, IIf([EffectClasse]=0,0,Round([Tranche2]/[EffectClasse]*100,2)) AS Taux2, Count(IIf([MOYG2] Between 0 And 8.49,1,Null)) AS Tranche3, IIf([EffectClasse]=0,0,Round([Tranche3]/[EffectClasse]*100,2)) AS Taux3, IIf([EffectClasse]<1,0,Round(Sum([MOYG2])/[EffectClasse],2)) AS MoyClasse
              FROM ((Niveaux INNER JOIN (TypesClasses INNER JOIN Classes ON TypesClasses.RefTypeClasse = Classes.RefTypeClasse) ON Niveaux.RefNiveau = TypesClasses.Niveau) INNER JOIN T_Notes ON Classes.RefClasse = T_Notes.RefClasse) INNER JOIN Elèves ON T_Notes.RefElève = Elèves.RefElève
              ...
              UNION ALL(
              SELECT 8 AS RefNiveau, "Synthèse" AS CycleX, 3 AS orderby, "Total GENERAL" AS NiveauSerie, "#E3E3E3" AS bg, Count(IIf([SEXE]=2,1,Null)) AS F1, Count(IIf([SEXE]=1,1,Null)) AS G1, [F1]+[G1] AS T1, Count(Elèves.RefElève) AS EffectTotal, Count(IIf([MOYG2] Is Null Or [SEXE]=2,Null,1)) AS F2, Count(IIf([MOYG2] Is Null Or [SEXE]=1,Null,1)) AS G2, [F2]+[G2] AS T2, Count(IIf([MOYG2] Is Null,Null,1)) AS EffectClasse, Count(IIf([MOYG2] Is Null,1,Null)) AS EffectNonClasse, Count(IIf([SEXE]=2 And [Redoub]=True,1,Null)) AS F3, Count(IIf([SEXE]=1 And [Redoub]=True,1,Null)) AS G3, [F3]+[G3] AS T3, Count(IIf([SEXE]=2 And [MOYG2]>=10,1,Null)) AS F4, Count(IIf([SEXE]=1 And [MOYG2]>=10,1,Null)) AS G4, [F4]+[G4] AS T4, Count(IIf([MOYG2]>=10,1,Null)) AS Tranche1, IIf([EffectClasse]=0,0,Round([Tranche1]/[EffectClasse]*100,2)) AS Taux1, Count(IIf([MOYG2] Between 8.5 And 9.99,1,Null)) AS Tranche2, IIf([EffectClasse]=0,0,Round([Tranche2]/[EffectClasse]*100,2)) AS Taux2, Count(IIf([MOYG2] Between 0 And 8.49,1,Null)) AS Tranche3, IIf([EffectClasse]=0,0,Round([Tranche3]/[EffectClasse]*100,2)) AS Taux3, IIf([EffectClasse]<1,0,Round(Sum([MOYG2])/[EffectClasse],2)) AS MoyClasse
              FROM ((Niveaux INNER JOIN (TypesClasses INNER JOIN Classes ON TypesClasses.RefTypeClasse = Classes.RefTypeClasse) ON Niveaux.RefNiveau = TypesClasses.Niveau) INNER JOIN T_Notes ON Classes.RefClasse = T_Notes.RefClasse) INNER JOIN Elèves ON T_Notes.RefElève = Elèves.RefElève
...
const chp2_D_repartition_des_eleves_par_annee_de_naissance = () => {
  return new Promise(async (resolve, reject) => {
    try {
      let sql = `SELECT IIf(IsNull([DateNaiss]),"Inconnue",Year([DateNaiss])) AS annee, IIf([Elèves].[Sexe]=2,"F","G") AS genre, 
      ...
      Count(IIf(Niveaux!RefNiveau=6 And TypesClasses!Série="D",1,Null)) AS 1ereD, Count(IIf([TypesClasses].[RefTypeClasse] In (10,13),1,Null)) AS TleA, Count(IIf(Niveaux!RefNiveau=7 And TypesClasses!Série="C",1,Null)) AS TleC, Count(IIf(Niveaux!RefNiveau=7 And TypesClasses!Série="D",1,Null)) AS TleD, Val([2ndA]+[2ndC]+[1ereA]+[1ereC]+[1ereD]+[TleA]+[TleC]+[TleD]) AS ST2, [ST1]+[ST2] AS TOTAL
...
const rapport = (data: any): Promise<any> => {
  ...
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const result = {
        ...dataParams,
        name_report: "prive_secondairegeneral_bouake2_2trimestre",
